# Premikanje robota med točkami iz YAML datoteke
import time
import yaml
...
# začetna pozicija (v mm)
start_point_mm = (400.0, 400.0, 400.0)

# Inicializacija robota
robot_init()

# Pretvorba iz mm in ° v notranji format robota
def to_internal(x_mm, y_mm, z_mm, rx_deg=0, ry_deg=0, rz_deg=0, re_deg=0):
...
# Branje točk iz YAML datoteke
with open("yaml/finish_points.yaml", 'r', encoding='utf-8') as f:
    tocke = yaml.safe_load(f)
