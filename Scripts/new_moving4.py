...
import time
import yaml
from robot_control import robot_init, moveL, move_complete
...
def horizontal_move(points, index, pause=0.1):
...
def main():
    ...
    filename = "saved_points/points.yaml"
    ...
    horizontal_move(points, index=0, pause=0.2)
